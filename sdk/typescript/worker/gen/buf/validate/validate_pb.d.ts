...
import type { BinaryReadOptions, Duration, Extension, FieldDescriptorProto_Type, FieldList, FieldMask, FieldOptions, JsonReadOptions, JsonValue, MessageOptions, OneofOptions, PartialMessage, PlainMessage, Timestamp } from "@bufbuild/protobuf";
 ...
 */
export declare class MessageOneofRule extends Message<MessageOneofRule> {
  /**
 ...
 */
export declare class OneofRules extends Message<OneofRules> {
  /**
 ...
 */
export declare class PredefinedRules extends Message<PredefinedRules> {
  /**
   * `cel` is a repeated field used to represent a textual expression
   * in the Common Expression Language (CEL) syntax. For more information,
 ...
 */
export declare class FieldMaskRules extends Message<FieldMaskRules> {
  /**
  ...
  constructor(data?: PartialMessage<FieldMaskRules>);

  static readonly runtime: typeof proto2;
  static readonly typeName = "buf.validate.FieldMaskRules";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): FieldMaskRules;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): FieldMaskRules;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): FieldMaskRules;

  static equals(a: FieldMaskRules | PlainMessage<FieldMaskRules> | undefined, b: FieldMaskRules | PlainMessage<FieldMaskRules> | undefined): boolean;
}
 ...
 */
export declare class FieldPath extends Message<FieldPath> {
  /**
 ...
 */
export declare class FieldPathElement extends Message<FieldPathElement> {
  /**
 ...
 */
export declare const message: Extension<MessageOptions, MessageRules>;
 ...
 */
export declare const oneof: Extension<OneofOptions, OneofRules>;
 ...
 */
export declare const field: Extension<FieldOptions, FieldRules>;
 ...
 */
export declare const predefined: Extension<FieldOptions, PredefinedRules>;
