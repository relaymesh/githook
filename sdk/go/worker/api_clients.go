...
func resolveEndpoint(explicit string) string {
	...
	if endpoint := envEndpoint("github.com/relaymesh/githook_ENDPOINT"); endpoint != "" {
		return endpoint
	}
	if endpoint := envEndpoint("github.com/relaymesh/githook_API_BASE_URL"); endpoint != "" {
		return endpoint
	}
...
func apiKeyFromEnv() string {
	return strings.TrimSpace(os.Getenv("github.com/relaymesh/githook_API_KEY"))
}

func envTenantID() string {
	return strings.TrimSpace(os.Getenv("github.com/relaymesh/githook_TENANT_ID"))
}
